...
def output-flake [envnames systems inputs outputs] {
    let default = (gen-one-env "envil-current" {extends: $envnames}).output
...
export def generate-flake [
    ...
    output-flake $envnames $systems $inputs $outputs |
